...
import { readFile, max, min, sum, Grid, Point, Range, rangeFromString } from '@aoc/common';
...
const rangesSorted = structuredClone(ranges).sort((a, b) => a.start - b.start).map(r => new Range(r.start, r.end));
